...
public class SelectGolfinho extends JFrame{
    public SelectGolfinho() throws Exception{
        JLabel golfinhos = new JLabel("Golfinhos" + DAO.selectGolfinho());
